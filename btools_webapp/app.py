...
def call_gemini_api(raw_text: str, api_key: str) -> dict:
    ...
    12. **ห้ามสร้างข้อมูลซ้ำซ้อน:** ข้อมูลใดที่คุณดึงไปจัดวางในรูปแบบ `"table"` แล้ว ห้ามนำข้อมูลนั้นมาสร้างเป็นหัวข้อ (title) หรือข้อย่อย (bullet) ซ้ำอีกภายนอกตารางเด็ดขาด!
