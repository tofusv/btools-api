...
def call_gemini_api(raw_text: str, api_key: str) -> dict:
    ...
    1. ห้ามใช้ตัวอักษรนำภาษาอังกฤษ a. b. c. หรือ a) b) c) นำหน้าข้อความเด็ดขาด! หากในต้นฉบับมี a. b. c. ให้ตัดอักษรนำออกทั้งหมด
    2. ลำดับหัวข้อ: H2 คือชื่อหมวดหลัก -> H3 คือหัวข้อรอง (เช่น รู้ คิด ทำ) -> H4 คือข้อย่อยใต้ H3 (เช่น เพื่อให้ผู้เข้าอบรม...)
    3. ตรวจสอบความซ้อนของหัวข้อใน Agenda อย่างละเอียดที่สุด:
    ...
    4. รูปแบบผลลัพธ์ต้องเป็น JSON ที่ valid เท่านั้น
